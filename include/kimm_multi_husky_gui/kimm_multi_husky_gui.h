...
namespace kimm_multi_husky_gui
{
    ...
    public:
        ...
        std::vector<sensor_msgs::JointState> target_q_vec_[2];
        std::vector<geometry_msgs::Transform>  target_x_vec_[2];
        std::vector<kimm_path_planner_ros_interface::Obstacle2D> obs_vec_[2];
